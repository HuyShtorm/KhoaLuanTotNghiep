...
import com.example.projectfinal.request.RefreshTokenRequest;
...
import com.example.projectfinal.response.TokenResponse;
...
public ResponseEntity<?> authenticateUser(@RequestBody LoginRequest loginRequest) {
    ...
    // API để gửi OTP cho quên mật khẩu
    ...
    // API để đặt lại mật khẩu mới sau khi nhận OTP
    ...
    public ResponseEntity<?> resetPassword(@RequestBody Map<String, String> request) {
        ...
        System.out.println("Reset password request received. Email: " + email + ", OTP: " + otp);
